...
def parse_args(argv):
    ...
    parser.add_argument('--db', type=str, dest='db_fn',
            help='read db file path [required]')
    parser.add_argument('--max_diff', type=int,
            help="max difference of 5' and 3' coverage [default=%(default)s]")
    parser.add_argument('--max_cov', type=int,
            help="max coverage of 5' or 3' coverage [default=%(default)s]")
    parser.add_argument('--min_cov', type=int,
            help="min coverage of 5' or 3' coverage [default=%(default)s]")
    ...
    parser.add_argument('--bestn', type=int, default=10,
            help="output at least best n overlaps on 5' or 3' ends if possible [default=%(default)s]")
